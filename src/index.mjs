...
import { handleDashboardAnalytics } from './routes/dashboard/analytics.mjs'; // New handler
...
router.get('/dashboard/posts', withPage-Auth, (req, env, ctx) => handleDashboardPosts(req, env, ctx));
router.get('/dashboard/settings', withPageAuth, (req, env, ctx) => handleDashboardSettings(req, env, ctx));
router.get('/dashboard/analytics', withPageAuth, (req, env, ctx) => handleDashboardAnalytics(req, env, ctx));
