// src/routes/dashboard-settings.mjs
...
import settingsTemplate from '../templates/dashboard/settings.html'; // Main content

const eta = new Eta();

export async function handleDashboardSettings(request, env, ctx) {
    ...
    finalLayout = finalLayout.replace('{{- it.contentTemplate }}', settingsTemplate);
